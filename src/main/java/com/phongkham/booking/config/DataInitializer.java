...
public class DataInitializer {
    ...
    public CommandLineRunner initDatabase(
            ...
            PasswordEncoder passwordEncoder) { // Inject thêm PasswordEncoder vào đây
        ...
        return args -> {
            ...
            if (countKhoa == 0) {
                ...
                ck1.setHinhAnh("/images/anh_bia.jpeg");
                ...
                ck1.setDoan_gioi_thieu("<strong>Khoa Nội</strong> là chuyên khoa lâm sàng chuyên tiếp nhận, chẩn đoán và điều trị toàn diện các bệnh lý xảy ra ở các cơ quan bên trong cơ thể...");
                ck1.setTieu_de_hang_muc("Các hệ cơ quan thăm khám chuyên sâu");
                ck1.setLoi_ket("Khoa Nội đóng vai trò là <strong>\"chìa khóa\"</strong> giúp phát hiện sớm các bất thường...");
                ...
                ck2.setHinhAnh("/images/anh_bia.jpeg");
                ...
                ck2.setDoan_gioi_thieu("<strong>Khoa Ngoại</strong> là chuyên khoa lâm sàng chuyên chẩn đoán, điều trị và sửa chữa các tổn thương...");
                ck2.setTieu_de_hang_muc("Các lĩnh vực điều trị và can thiệp ngoại khoa");
                ck2.setLoi_ket("Khoa Ngoại đóng vai trò quyết định trong việc giải quyết nhanh chóng và triệt để các bệnh lý...");
                ...
                ck3.setHinhAnh("/images/anh_bia.jpeg");
                ...
                ck3.setDoan_gioi_thieu("<strong>Khoa Mắt</strong> chuyên thăm khám, chẩn đoán, điều trị và chăm sóc toàn diện...");
                ck3.setTieu_de_hang_muc("Các hạng mục thăm khám và điều trị");
                ck3.setLoi_ket("Khoa Mắt đóng vai trò quan trọng trong việc bảo vệ <strong>\"đôi mắt sáng\"</strong>...");
                ...
                ck4.setHinhAnh("/images/anh_bia.jpeg");
                ...
                ck4.setDoan_gioi_thieu("<strong>Khoa Da liễu</strong> chuyên thăm khám, chẩn đoán, điều trị và chăm sóc toàn diện...");
                ck4.setTieu_de_hang_muc("Các hạng mục điều trị và thẩm mỹ da");
                ck4.setLoi_ket("Khoa Da liễu đóng vai trò cốt lõi trong việc phục hồi hàng rào bảo vệ da...");
                ...
                ck5.setHinhAnh("/images/anh_bia.jpeg");
                ...
                ck5.setDoan_gioi_thieu("<strong>Khoa Răng - Hàm - Mặt</strong> chuyên thăm khám, chẩn đoán, điều trị...");
                ck5.setTieu_de_hang_muc("Các hạng mục điều trị và thẩm mỹ nha khoa");
                ck5.setLoi_ket("Khoa Răng - Hàm - Mặt đóng vai trò quan trọng trong việc khôi phục chức năng ăn nhai...");
                ck5.setDanh_sach_hang_muc(List.of(
                    ...
                    new HangMuc("😁", "Chỉnh nha (Niềng răng)", "Khắc phục các tình trạng răng hô, móm, thưa, lệch lạc...")
                ));
                listKhoa.add(ck5);
